 ...
 * ```
 *
 * @see https://airquality.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/airquality';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\AirqualityClient] {$message}\n";
        }
    }
}
