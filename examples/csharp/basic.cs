/*
 * Air Quality API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Air Quality API.
 * API Documentation: https://docs.apiverve.com/ref/airquality
 */
...
namespace APIVerve.Examples
{
    class AirQualityExample
    {
        ...
        private static readonly string API_URL = "https://api.apiverve.com/v1/airquality";

        /// <summary>
        /// Make a GET request to the Air Quality API
        /// </summary>
        static async Task<JsonDocument> CallAirQualityAPI()
        {
            try
            {
        ...
        {
            Console.WriteLine("📤 Calling Air Quality API...\n");

            var result = await CallAirQualityAPI();
