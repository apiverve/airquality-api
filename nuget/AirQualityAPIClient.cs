...
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/airquality";
        ...
        public AirQualityAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public AirQualityAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public AirQualityAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, AirQualityQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(AirQualityQueryOptions options)
        {
        ...
        public ResponseObj Execute(AirQualityQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(AirQualityQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(AirQualityQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(AirQualityQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(AirQualityQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(AirQualityQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(AirQualityQueryOptions options)
        {
