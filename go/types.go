// Package airquality provides a Go client for the Air Quality API.
//
// For more information, visit: https://airquality.apiverve.com?utm_source=go&utm_medium=readme
package airquality
...
// Request contains the parameters for the Air Quality API.
//
// Parameters:
//   - city (required): string - The city name for which you want to get the air quality data (e.g., New York)
type Request struct {
...
// ResponseData contains the data returned by the Air Quality API.
type ResponseData struct {
	Pm2_5 float64 `json:"pm2_5"`
	Pm10 float64 `json:"pm10"`
	Us-epa-index int `json:"us-epa-index"`
	Gb-defra-index int `json:"gb-defra-index"`
	CarbonMonoxide float64 `json:"carbonMonoxide"`
	Ozone int `json:"ozone"`
	NitrogenDioxide float64 `json:"nitrogenDioxide"`
	Sulfurdioxide float64 `json:"sulfurdioxide"`
