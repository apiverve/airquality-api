...
```gradle
dependencies {
    implementation 'com.github.apiverve:airquality-api:1.1.14'
}
```
...
```java
import com.apiverve.airquality.AirQualityAPIClient;
import com.apiverve.airquality.APIResponse;
import com.apiverve.airquality.APIException;

// Initialize the client
AirQualityAPIClient client = new AirQualityAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/airquality](https://docs.apiverve.com/ref/airquality)
...
- **Documentation:** [https://docs.apiverve.com/ref/airquality](https://docs.apiverve.com/ref/airquality)
- **Issues:** [GitHub Issues](https://github.com/apiverve/airquality-api/issues)
